...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XVIEWAlipayManager.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/maomao520benben/XVIEWAlipayManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'maomao520benben' => 'key@xiaheng.net' }
  s.source           = { :git => 'https://github.com/maomao520benben/XVIEWAlipayManager.git', :tag => s.version.to_s }
